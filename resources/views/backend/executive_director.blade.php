        ...
        <div class="card-body">
            ...
            <table class="table table-bordered">
                <tr>
                    ...
                    <form action="{{ route('admin.executive.director.title') }}" method="POST">
                        @csrf
                        <td>
                ...
                <tr>
                    ...
                    <form action="{{ route('admin.executive.director.speech') }}" method="POST">
                        @csrf
                        <td width="60%">
                ...
                <tr>
                    ...
                    <form action="{{ route('admin.executive.director.image') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <td>
