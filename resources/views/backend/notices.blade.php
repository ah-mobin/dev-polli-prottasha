            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <button type="button" class="btn btn-warning text-light ms-3" data-bs-toggle="modal" data-bs-target="#remeoveNotice{{ $item->id }}">
                            Remove
                          </button>
                        </td>
                    </tr>
                    ...
                    <!-- Delete Modal -->
                    <div class="modal fade" id="remeoveNotice{{ $item->id }}" tabindex="-1" aria-labelledby="removeEventLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        <form action="{{ route('admin.notice.delete',$item->id) }}" method="post">
                          @csrf
                          @method('delete')
        ...
        <form action="{{ route('admin.notice.store') }}" method="post" enctype="multipart/form-data">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="createNoticeLabel">Create Notice</h5>
